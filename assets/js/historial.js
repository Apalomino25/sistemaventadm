...
//     fetch(`/sistemaventaDM/controllers/ver_detalle.php?id=${ventaID}`)
//         .then(res => res.text())
//         .then(html => {
...
/* FUNCIONES QUE NO FUNCIONAN PORQUE SE CONF EN POS.JS */ 
...
//     // IMPRIMIR (lo dejas igual)
//     if (e.target.classList.contains("imprimir")) {
//         const id = e.target.dataset.id;
//         imprimirVenta(id);
//     }

//     // ✅ VER DETALLE (CORREGIDO SOLO AQUÍ)
//     const btnVer = e.target.closest("i.ver");
//     if (btnVer) {
